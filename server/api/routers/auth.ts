    ...
    signUp: publicProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            try {
                ...
                if (fireUser) await adminAuth.deleteUser(fireUser.uid); // Clean up if user creation fails
                throw new TRPCError({ code: 'BAD_REQUEST', message: error instanceof Error ? error.message : defaultError });
            }
            ...
            try {
                ...
                console.error('Error creating UserAccount in Prisma:', error);
